package org.cronhub.dispatchexecutor.caller.gen;
/**
...
public class ExecutorService {
    ...
    public static class Client extends org.apache.thrift.TServiceClient implements Iface {
        ...
        public ExecuteDoneReportResult executeCmd(String cmd, long task_id, boolean undoReportHttp,
                                                  String undoReportHttpUrl, int exec_type, boolean delTempFile,
                                                  Extra extra) throws org.apache.thrift.TException {
            send_executeCmd(cmd, task_id, undoReportHttp, undoReportHttpUrl, exec_type, delTempFile, extra);
            return recv_executeCmd();
        }

        public void send_executeCmd(String cmd, long task_id, boolean undoReportHttp, String undoReportHttpUrl,
                                    int exec_type, boolean delTempFile,
                                    Extra extra) throws org.apache.thrift.TException {
        ...
        public ExecuteDoneReportResult recv_executeCmd() throws org.apache.thrift.TException {
            ...
            throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT,
                    "executeCmd failed: unknown result");
        }
    ...
    public static class executeCmd_result implements
            org.apache.thrift.TBase<executeCmd_result, executeCmd_result._Fields>,
            java.io.Serializable, Cloneable {
        private static final org.apache.thrift.protocol.TStruct STRUCT_DESC
                = new org.apache.thrift.protocol.TStruct("executeCmd_result");
